...
//#define STATIC_IP_ADDRESS undefined //${static_ip_address_pattern}
//#define SUBNET_MASK undefined // REQUIRED for ESP8266_WIFI, optional for others ${subnet_mask_pattern}
//#define GATEWAY_IP_ADDRESS undefined // REQUIRED for ESP8266_WIFI, optional for others ${gateway_ip_address_pattern}
...
#define SERVER_PORT 3030 //${server_port_pattern}
